        ...
        <footer className="w-full bg-gradient-to-r from-green-600 via-green-700 to-green-800 text-white py-8">
            <div className="max-w-7xl mx-auto px-6 flex flex-col md:flex-row items-center justify-between gap-6">
                ...
                <div className="flex space-x-5">
                    <a href="https://github.com/" target="_blank" className="hover:text-green-300 transition-colors">
                    ...
                    <a href="https://linkedin.com/" target="_blank" className="hover:text-green-300 transition-colors">
                        <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                            <path
