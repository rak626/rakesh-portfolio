                ...
                <div className="relative">
                    ...
                    {dropdownOpen && (
                        <>
                            ...
                            />
                            <div
                                className="absolute top-full left-0 mt-2 w-72 max-h-80 overflow-y-auto rounded-xl bg-[var(--bg-primary)] border border-[var(--border)] shadow-xl z-50">
                                {countries.map((country) => (
                                    ...
                                    >
                                        ...
                                        <span
                                            className="text-xs text-[var(--text-secondary)]">+{country.dialCode}</span>
                                    </button>
                                ))}
                            </div>
                        </>
